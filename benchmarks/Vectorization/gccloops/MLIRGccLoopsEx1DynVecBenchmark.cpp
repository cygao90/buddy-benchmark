...
intptr_t sizesInputArrayMLIRGccLoopsEx1_1[1] = {SIZE};
intptr_t sizesInputArrayMLIRGccLoopsEx1_2[1] = {SIZE};
intptr_t sizesOutputArrayMLIRGccLoopsEx1[1] = {SIZE};
...
void generateResultMLIRGccLoopsEx1DynVec() {
  ...
  std::cout << "--------------------------------------------------------"
            << std::endl;
  std::cout << "MLIR_GccLoopsEx1DynVec: MLIR GccLoopsEx1 Operation" << std::endl;
  std::cout << "[ ";
